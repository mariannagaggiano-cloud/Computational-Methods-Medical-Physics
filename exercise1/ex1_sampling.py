...
plt.figure(figsize=(10, 6))
plt.suptitle("Linear Fit Standard Error of the Mean (Sampling Mean Method)", fontsize=18)
...
plt.figure(figsize=(10, 6))
plt.suptitle("Convergence to the Correct Answer (Sampling Mean Method)", fontsize=18)
